      ...
      <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programs.map((program, index) => (
            <div key={index} className="relative bg-indigo-700 p-6 rounded-lg shadow-lg text-center">
              <h2 className="text-2xl font-semibold mb-4">{program}</h2>
              <div className="absolute top-2 left-2">
                <Link href={`dashboard/programs/${program}/participants`} legacyBehavior>
              ...
              <div className="flex justify-center space-x-4 mt-6">
                <Link href={`dashboard/programs/${program}/template`} legacyBehavior>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex items-center justify-center">
            <Link href={`dashboard/create`} legacyBehavior>
              <a className="text-green-300 hover:text-green-500 text-4xl">+</a>
            </Link>
          </div>
        </div>
      </div>
